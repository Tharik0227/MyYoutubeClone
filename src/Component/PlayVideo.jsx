...
import son from '../assets/sony_profile.jpg'
import user_profi from '../assets/user_profile.jpg'
...
const PlayVideo = () => {
  ...
  const fetchOtherData = async () =>{
    ...
    await fetch(comment_url).then(res=>res.json()).then(data=>setCommendData(data.items))
  }
  useEffect(() => {
    fetchVideoData(); 
    }, [videoId]);
  ...
  return (
    <div className='play-video'>
      {/* <video src={vida} controls autoPlay muted  ></video> */}
